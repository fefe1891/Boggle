...
class Boggle():
    ...
    def read_dict(self, dict_path):
        ...
        try:
            ...
            print(f"No dictionary found at the path: {dict_path}")
            word = []
            
        print(f"Read {len(words)} words from {dict_path}")
        return words
    ...
    def check_valid_word(self, board, word):
        ...
        # change here - convert word to uppercase before checking if it exists in self.words
        word_exists = word.upper() in self.words
        # Debug print - print whether the word exists in dictionary
        print(f"{word} exists in dictionary: {word_exists}")

        valid_word = self.find(board, word.upper())
        # Debug print - print whether the word was found on the board
        print(f"{word} found in board: {valid_word}")
